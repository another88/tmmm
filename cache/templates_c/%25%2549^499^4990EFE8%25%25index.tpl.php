<?php /* Smarty version 2.6.19, created on 2017-03-18 15:17:04
...
<div class="contentInner">
    ...
    <?php if (count ( $this->_tpl_vars['currentCategory']['product']['data'] ) > 0): ?>
        <?php $_from = $this->_tpl_vars['currentCategory']['product']['data']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['iter'] = array('total' => count($_from), 'iteration' => 0);
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <?php endif; ?>
    <?php if (! empty ( $this->_tpl_vars['currentCategory']['description'] )): ?>
        ...
        <div class="catText">
            ...
            <div class="catPageTextShare">
                <div class="share42init"
                     data-url="http://ace-hookah.com/catalog/<?php echo $this->_tpl_vars['currentCategory']['url']; ?>
.html"
                     data-title="<?php echo $this->_tpl_vars['currentCategory']['title']; ?>
"
                     data-description="<?php echo $this->_tpl_vars['currentCategory']['description']; ?>
"
                ></div>        
                <?php echo '
