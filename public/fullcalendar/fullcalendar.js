			...
			element = $("<table class='fc-header' style='width:100%'/>")
				.append(
					$("<tr/>")
						...
						.append(EventInclude ? '<td class="fc-header-right"><span onclick="location.href=rootPath +\'conference_event_list.html\'" onmouseover="if (!$(this).hasClass(\'MouseHoverStanded\')){$(this).addClass(\'MouseHoverStanded fc-state-hover\').hover(function(){$(this).addClass(\'fc-state-hover\')},function(){$(this).removeClass(\'fc-state-hover\')})}" class="fc-button fc-state-default fc-corner-left fc-corner-right"><span class="fc-button-inner"><span class="fc-button-content">List</span><span class="fc-button-effect"><span></span></span></span></span></td>' : '')
...
$(document).ready(function(){
    var type = typeof CAL_OPEN_START == undefined;
    if ( !type )
        CAL_OPEN_START = false
    setTimeout(function(){
        if ( $.type(CAL_OPEN_START) == 'string' )
        {
            switch ( CAL_OPEN_START )
            {
                case 'month':
                    //$('.fc-button-basicMonth').trigger('click');
                    break;
                case 'week':
                    $('.fc-button-basicWeek').click();
                    break;
                case 'day':
                    $('.fc-button-basicDay').click();
                    break;
                default:
                    $('.fc-button-basicMonth').trigger('click');
                    break;
